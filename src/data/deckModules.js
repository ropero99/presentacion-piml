// Módulos del deck — espejo de las secciones del documento
...
export const MODULES = [
  ...
  { id: 'd4', label: 'D4 · Intersección', tone: 'magenta' },
  { id: 'd5', label: 'D5 · Problemas', tone: 'cyan' },
  { id: 'd6', label: 'D6 · Opciones', tone: 'red' },
  { id: 'lectura', label: 'Lectura conjunta', tone: 'green' },
  { id: 'cierre', label: 'Notas y cierre', tone: 'yellow' },
];
